...
public class PaymentServiceImpl implements PaymentService {
	...
	//결제정보를 취소하는 OpenAPI를 사용해 취소결과를 반환하는 메소드
	@Override
	public String canclePayment(String accessToken, Payment payment) {
		//결재 취소를 요청하기 위한 OpenAPI의 URL 주소 저장
				...
				String data="{\"imp_uid\":\""+payment.getImpUid()+"\", \"checksum\":\""+payment.getPaymentTotal()+"\"}";
