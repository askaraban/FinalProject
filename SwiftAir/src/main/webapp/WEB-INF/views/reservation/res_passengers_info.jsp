...
<title>Flight - Passenger Info</title>
<!-- PLUGINS CSS STYLE -->
  ...
  <div class="container">
    <nav class="bg-transparent breadcrumb breadcrumb-2 px-0 mb-5" aria-label="breadcrumb" style="--bs-breadcrumb-divider: none;">
      ...
      <ul class="list-unstyled d-flex p-0 m-0">
        ...
        <li class="breadcrumb-item"><img src="../assets/img/seat-option/check_icon.png"></li><!-- 수정중 -->
        <li class="breadcrumb-item"><img src="../assets/img/seat-option/check_icon.png"></li>
        <li class="breadcrumb-item"><img src="../assets/img/seat-option/circle_icon.png"><br>탑승객 정보</li>
      </ul>
    </nav>
    </div>
  </div>
...
<style>
  .breadcrumb-item:not(:last-child)::after {
    content: url('../assets/img/seat-option/arrow_icon.png');
