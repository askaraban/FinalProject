					...
					<div class="row align-items-center">
						<div class="col-sm-6 px-2">
							<div class="form-check form-check-inline col-sm-12 border rounded px-6">
								<input class="form-check-input me-3" type="radio" name="resArrSeatGrade" id="economy35" value="economy35" onclick="showSeatImage('economy35')">
						...
						<div class="col-sm-6 px-2">
							<div class="form-check form-check-inline col-sm-12 border rounded px-6">
								<input class="form-check-input me-3" type="radio" name="resArrSeatGrade" id="premia42" value="premia42"onclick="showSeatImage('premia42')">
