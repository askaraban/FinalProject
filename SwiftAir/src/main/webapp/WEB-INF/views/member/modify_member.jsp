...
<form id = "modify" action="<c:url value="/member/modifyMemberAction"/>" method="post">
				...
				<div class="col-sm-8">
		            <div class="form-group col-sm-12">
		            	<div class="input-group mb-2">
		            		...
		            		<input type="text" class="form-control" name = "memberId" id = "memberId" value = "${loginMember.memberId}" >
		            	</div>
		            	<label id="idCheck"></label>
		            	<div class="input-group mb-2">
		            		<div class="input-group-text col-sm-2 text-center">비밀번호</div>
		            		<input type="password" class="form-control" name = "memberPswd" id = "memberPswd" value = "${loginMember.memberPswd}">
		            	</div>
		            	<div class="input-group mb-2">
		            		<div class="input-group-text col-sm-2 text-center">이름</div>
		            		<input type="text" class="form-control" name = "memberKorName" id = "memberKorName" value = "${loginMember.memberKorName}">
		            	</div>
		            	<div class="input-group mb-2">
		            		<div class="input-group-text col-sm-2 text-center">영어 성</div>
		            		<input type="text" class="form-control" name = "memberFirstName" id = "memberFirstName" value = "${loginMember.memberFirstName}"> 
		            	</div>
		            </div>
		            	<div class="input-group mb-2">
		            		<div class="input-group-text col-sm-2 text-center">영어 이름</div>
		            		<input type="text" class="form-control" name = "memberLastName" id = "memberLastName" value = "${loginMember.memberLastName}">
		            	</div>
		            	<div class="input-group mb-2">
		            		<div class="input-group-text col-sm-2 text-center">이메일</div>
		            		<input type="text" class="form-control" name = "memberEmail" id = "memberEmail" value = "${loginMember.memberEmail}">
		            	</div>
		            	
		            	<div class="input-group mb-2">
		            		<div class="input-group-text col-sm-2 text-center">핸드폰 번호</div>
		            		<input type="text" class="form-control" name = "memberPhone" id = "memberPhone" value = "${loginMember.memberPhone}">
		            	</div>
