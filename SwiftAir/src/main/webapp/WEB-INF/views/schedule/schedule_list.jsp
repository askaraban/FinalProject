  ...
  <div class="container">
    ...
    <table id="my-booking" class="display nowrap table-data-default" style="width:100%">
      <thead style="text-align:center">
        <tr>
          <th style="border: 1px solid #dee2e6; font-size: 20px;">항공기명</th>
          <th style="border: 1px solid #dee2e6; font-size: 20px;">출발지</th>
          <th style="border: 1px solid #dee2e6; font-size: 20px;">도착지</th>
          <th style="border: 1px solid #dee2e6; font-size: 20px;">운항시간</th>
          <th style="border: 1px solid #dee2e6; font-size: 20px;">가격</th>
          <th style="border: 1px solid #dee2e6; font-size: 20px;">출발일</th>
          <th style="border: 1px solid #dee2e6; font-size: 20px;">도착일</th>
