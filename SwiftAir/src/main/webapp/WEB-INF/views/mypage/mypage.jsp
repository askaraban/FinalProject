...
<section style="width: 100%; margin: 20px;" >
  <div class="container">
      ...
      <div class="col-md-7 col-lg-8" style="width: 100%; margin-top: 20px;">
        <div class="card">
          <div class="card-body p-6" style="display: flex; flex-direction: row; align-items: center;">
            <div class="col-md-5 col-lg-4">
	          <!-- <div class="card card-profile"> -->
	          <div>
	           <!-- <div class="card-profile-img py-6" style="text-align: center;">  --> 
	           <div style="text-align: center;">  
	            <img class="rounded-circle lazyestload" data-src="../mypage/user.png" src="../mypage/user.png" alt="Image" style="width:50%; height: 50%; border-color: gray; ">
	           </div>
	          </div>
	        </div>
	       ...
	       <div class="col-md-5 col-lg-4" style="float: right;">
	          <div class="card-profile-img py-6"  style="text-align: center;"> 
	            ...
	            <h3>나의 등급</h3>
	            <a href="pricing-table.html" class="btn btn-white btn-lg mb-3"> > BLUE</a>
	          	</div>
	          	
	          	<div style="margin: 10px;">
	            <h3>포인트</h3>
	            <a href="pricing-table.html" class="btn btn-white btn-lg mb-3"> > 10만P</a>
	          	</div>
	        </div>
	        </div>
     ...
     <div> 
      <ul class="nav nav-pills">
		  ...
		  <li class="nav-item" style="margin: 5px;">
		    <a href="#nav-pills-tab-2" data-bs-toggle="tab" class="nav-link active" style="background-color: #43C4AE;">지난 여정</a>
		  </li>
		   <li class="nav-item" style="margin: 5px;">
		    <a href="#nav-pills-tab-3" data-bs-toggle="tab" class="nav-link active" style="background-color: #43C4AE;">나의 분실물 내역</a>
		  </li>
		</ul>
